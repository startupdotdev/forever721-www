...
<div class="pb-12">
	<div class="px-4">
		...
		<div class="mb-12 text-center">
			<h1 class="text-left text-3xl heading mb-2">Forever721 NFT Analysis</h1>
			<h2 class="text-left text-xl semi-bold mb-2">
				NFTs are permanent. Sometimes their contents are not.
			</h2>
			<p class="text-left text-sm mb-12">
	...
	<div class="bg-gray-100 p-4 pt-12">
		<div class="mb-4">
	...
	<div class="text-center">
		<a
			href="/#scan-an-nft"
			class="bg-gray-900 rounded-full text-white px-8 py-4 border border-white mb-8 inline-block"
			>Analyze an NFT 👆</a
		>
	</div>
</div>
